...
function readEmbeddingInputs() {
  ...
  const fakeCoverEl = document.getElementById('embedFakeCover');
  if (coverEl) coverEl.value = coverEl.value.trim();
  if (fakeCoverEl) fakeCoverEl.value = fakeCoverEl.value.trim();

  return {
    coverText: coverEl ? coverEl.value : '',
    ...
    fakeCoverText: fakeCoverEl ? fakeCoverEl.value : '',
  };
}
