...
const CHAT_PLATFORMS = {
  ...
  // ── WhatsApp Android ────────────────────────────────
  // Format: "12/5/26, 2:30 PM – text: text textmessage"
  ...
  // ── WhatsApp iOS ────────────────────────────────────
  // Format: "[12/5/26, 2:30:00 PM] text: text textmessage"
  whatsapp_ios: {
    name: 'WhatsApp (iOS)',
  ...
  // ── Telegram ────────────────────────────────────────
  // Exported format: "text, [12.05.26 14:30]\ntext textmessage"
  ...
  // ── Signal ──────────────────────────────────────────
  // Format: "text, 2:30 PM: text textmessage"
  signal: {
    name: 'Signal',
...
function getSupportedPlatforms() {
  const platforms = [{ key: 'auto', name: '🔍 text text' }];
  for (const [key, platform] of Object.entries(CHAT_PLATFORMS)) {
    platforms.push({ key, name: platform.name });
  }
  platforms.push({ key: 'generic', name: '📝 plain text (each line = message)' });
  return platforms;
}
