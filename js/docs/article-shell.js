...
<ul><li><strong>Static hosting:</strong> All UI and algorithms run in the browser; no server is required for embed/extract.</li><li><strong>Local development:</strong> Open HTML files or serve the project folder with any static file server.</li></ul>
...
<body class="docs-body">
  ...
  <footer class="main-footer">
    <div class="main-footer__inner">
      <div class="main-footer__brand"><div class="main-footer__title">STEGNOLINES</div></div>
      <div class="main-footer__links-group">
        <ul class="main-footer__links">
          <li><a href="../../documentation.html" class="main-footer__link">Documentation</a></li>
        </ul>
      </div>
    </div>
    <div class="main-footer__bottom"><span>&copy; 2026 STEGNOLINES. All rights reserved.</span></div>
  </footer>
